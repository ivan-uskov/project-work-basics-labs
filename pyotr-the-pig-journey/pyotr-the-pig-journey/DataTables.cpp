...
std::vector<TractorData> initializeTractorData()
{
    ...
    data[Tractor::Eagle].textureRect = sf::IntRect(0, 105, 145, 113);
...
std::vector<ProjectileData> initializeProjectileData()
{
    ...
    data[Projectile::AlliedBullet].textureRect = sf::IntRect(175 + 56, 64 + 30, 14, 3);

    data[Projectile::EnemyBullet].damage = 10;
    data[Projectile::EnemyBullet].speed = 300.f;
    data[Projectile::EnemyBullet].texture = Textures::Entities;
    data[Projectile::EnemyBullet].textureRect = sf::IntRect(178 + 53, 64 + 33, 14, 3);

    data[Projectile::Missile].damage = 200;
    data[Projectile::Missile].speed = 150.f;
    data[Projectile::Missile].texture = Textures::Entities;
    data[Projectile::Missile].textureRect = sf::IntRect(160 + 71, 64, 32, 15);
